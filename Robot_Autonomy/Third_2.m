...
Kp = diag([0.8687/25; 0.8687/25; 2.5896*5; 0.2370*5; 0.2370*10; 0.0217]);
Kd = diag([1.0869/15; 1.0869/15; 1.0869*10; 0.0272*4; 0.0272*15; 0.0099]);
...
%       imu_updated
    if odom_idx > 1 && imu_idx> 1 && odom_updated && imu_updated
       ...
       % pos_des(:,pos_idx)
        ...
        Error_position = [Error_position, norm(e_vel(:,err_idx))];
        ...
        Error_orientation = [Error_orientation, norm(e_att(:, err_idx))];
