...
%%  calculate p1,p2 and p3 target points
laserpoint1=[482 45 360]';
laserpoint2=[483 35 360]';
laserpoint3=[465 44 360]';
centroid=(laserpoint1+laserpoint2+laserpoint3)/3;
P2_target=centroid;
laser_vector_1to2=laserpoint2-laserpoint1;
laser_vector_1to3=laserpoint3-laserpoint1;
vector_surface=cross(laser_vector_1to3,laser_vector_1to2);
unit_vector_surface=vector_surface/norm(vector_surface);
P1_target=P2_target+10*unit_vector_surface;
